...
export const zh = {
  ...
  'delete.session.desc': '将永久删除“{name}”的本地会话记录与日志，此操作无法撤销。',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes “{name}”’s local session record and log. This cannot be undone.',
