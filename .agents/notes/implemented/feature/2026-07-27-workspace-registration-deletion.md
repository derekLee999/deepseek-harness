...
The menu, Modal, and buttons retain their existing structure and design tokens. Session deletion ships separately as a destructive session-domain operation ([the session deletion decision](2026-08-15-session-deletion.md)).
